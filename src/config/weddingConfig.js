...
import { couple, venues, gallery } from '../data'
...
export const weddingConfig = {
  ...
  rsvp: {
    ...
    phone: "",
    website: "",
    message: "Please RSVP by April 25th, 2026"
  },

  // Theme and Styling - Burgundy Red Wine
  theme: {
    primaryColor: "navy",
    secondaryColor: "gray-wedding-dark",
  ...
  // Photos and Media
  photos: {
    hero: "/assets/images/prenup/1000082213.jpg",
    gallery: (gallery.images || []).slice(0, 4),
